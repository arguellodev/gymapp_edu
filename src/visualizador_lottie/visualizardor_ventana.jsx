...
import './visualizador_ventana.css'
const LottieAnimationVentana = ({ jsonPath, setLottieVentana}) => {
  ...
  return (
       <div ref={containerRef} className="lottie-container-ventana">
    ...
    overflow: "hidden"
       ...
       <button className="boton-cerrar-lottie" onClick={()=>{setLottieVentana(false)}}>Cerrar Lottie</button>
    </div>
    
);
};

export default LottieAnimationVentana;